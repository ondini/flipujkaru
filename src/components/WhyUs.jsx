        ...
        <Reveal delay={80} className="mt-12">
          <div className="grid items-center gap-8 rounded-3xl border border-accent/25 bg-ink-850 p-7 md:p-10 lg:grid-cols-2 shadow-glow">
            <div>
              ...
              <p className="mt-3 inline-flex items-center gap-2 rounded-xl border border-accent/20 bg-accent-soft px-3.5 py-2 text-sm font-semibold text-accent">
                <Sparkles className="h-4 w-4 shrink-0" /> Každý týden nový seznam aut pod tržní cenou napříč Evropou
              </p>
